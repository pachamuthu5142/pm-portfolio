                ...
                <motion.div ref={ref} style={{ scale }}>
                    ...
                    {isInView && (
                        <motion.div initial={{ opacity: 0, y: -70 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.5, delay: 1 }} className="about-content text-white w-[80%] mx-auto my-[3rem]">
                            Welcome to my portfolio! I&apos;m Pachamuthu, a dedicated and creative web designer and developer from India. With 3+ years of experience in the industry, I specialize in building visually appealing and user-friendly websites that deliver outstanding user experiences.
                        </motion.div>
                    )}
